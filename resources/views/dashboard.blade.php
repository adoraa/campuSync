          ...
          <div class="row">
            ...
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <h3 class="text-primary number">{{ $num_roles }}</h3>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <h3 class="text-primary number">{{ $num_categories }}</h3>
            ...
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <h3 class="text-primary number">{{ $num_complaints }}</h3>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <p class="stat-text">Jobs Completed</a></p>
              </div>
            </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <p class="stat-text"><a href="{{ route('job_assigned') }}">Job Assigned</a> </p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <p class="stat-text">Room Users</a></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <p class="stat-text"><a href="{{ route('room.index') }}">Rooms</a></p>
              </div>
            </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <p class="stat-text">Facility Users</a></p>
              </div>
            </div>
          </div>
        </div>
